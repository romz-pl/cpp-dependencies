...
Operations::Operations(int argc, const char** argv)
    : loadStatus(Unloaded)
...
void Operations::RegisterCommands() {
...
void Operations::RunCommand(std::vector<std::string>::iterator &arg, std::vector<std::string>::iterator &end) {
...
void Operations::LoadProject(bool withLoc) {
...
void Operations::Dir(std::vector<std::string> args) {
	if (args.empty()) {
...
void Operations::Ignore(std::vector<std::string> args) {
	if (args.empty())
...
void Operations::Infer(std::vector<std::string> ) {
	inferredComponents = true;
	UnloadProject();
}

void Operations::Drop(std::vector<std::string> args) {
	if (args.empty())
		std::cout << "No files specified to ignore?\n";
...
void Operations::Graph(std::vector<std::string> args) {
	LoadProject();
	if (args.empty()) {
...
void Operations::GraphCycles(std::vector<std::string> args) {
	LoadProject();
	if (args.empty()) {
...
void Operations::GraphTarget(std::vector<std::string> args) {
	LoadProject();
	if (args.size() != 2) {
...
void Operations::Cycles(std::vector<std::string> args) {
	LoadProject();
	if (args.empty()) {
...
void Operations::Stats(std::vector<std::string>) {
	LoadProject(true);
...
void Operations::InOut(std::vector<std::string> args) {
	LoadProject();
	if (args.empty())
		std::cout << "No targets specified for finding in- and out-going links.\n";
	for (auto& s : args) {
...
void Operations::Shortest(std::vector<std::string> args) {
	LoadProject();
	if (args.size() != 2) {
...
void Operations::Info(std::vector<std::string> args) {
	LoadProject();
	if (args.empty())
...
void Operations::UsedBy(std::vector<std::string> args) {
	LoadProject();
	if (args.empty())
...
void Operations::IncludeOrigin(std::vector<std::string> args) {
	LoadProject();
	if (args.size() != 2) {
...
void Operations::Regen(std::vector<std::string> args) {
...
void Operations::DryRegen(std::vector<std::string> args) {
	DoActualRegen(args, true);
}

void Operations::FixIncludes(std::vector<std::string> args) {
...
void Operations::Outliers(std::vector<std::string>) {
	LoadProject(true);
...
void Operations::IncludeSize(std::vector<std::string>) {
	LoadProject(true);
...
void Operations::Ambiguous(std::vector<std::string>) {
	LoadProject();
...
void Operations::Recursive(std::vector<std::string>) {
	recursive = true;
	UnloadProject();
}

void Operations::Help(std::vector<std::string>) {
